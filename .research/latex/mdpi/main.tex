...
\caption{Cumulative accuracy over evaluation questions for an individual run; higher values indicate better performance.}\label{fig:accuracy-progress}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.7\linewidth]{images/comparison_accuracy.pdf}
\caption{Accuracy comparison across runs; higher values indicate better performance.}\label{fig:comparison-accuracy}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.7\linewidth]{images/comparison_accuracy_progress.pdf}
\caption{Overlay of cumulative accuracy progress across runs; higher values indicate better performance.}\label{fig:comparison-accuracy-progress}
\end{figure}
